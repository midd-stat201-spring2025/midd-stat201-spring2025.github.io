...
-   ::: discuss
    ...
    -   $H_{0}$: $\mu =$ `r mu0` versus $H_{A}$: $\mu\neq$ `r mu0`, where $\mu$ is the true average house of prices in Duke Forest in \$100,000
...
The observed/sample mean housing price is $\bar{x} =$ `r xbar` from a sample of `r n` houses.
