...
-   In 2005, the Florida legislature passed a controversial "Stand Your Ground" law
    ...
    -   Proponents of the law thought it woulf reduce crime, opponents worried it was increase the amount of lethal force
...
-   Often a result of lack of transparency
...
-   Such program are considered effective at improving outcomes and satisfaction while reducing costs, but are themselves costly -\> want to identify patients who had the highest "medical need"
...
-   Assigned patients a "risk score", where higher risk meant more complex needs and therefore priority
    ...
    -   Patient with lower (but still high) risk scores were interviewed for potential candidacy
...
:::: {.column width="30%"}
::: discuss
Interpret the plot[^3]. What do you notice happened?
:::
::::
...
## Example 4: ProPublica analysis[^4]
...
-   For more than 7,000 people arrested in Broward County, Florida in 2013 and 2014:

    -   "Risk scores" were assigned via an algorithm that were used to predict the likelihood of the person committing a future crime

-   To see how the risk scores did, these people were tracked to see if they charged with new crimes over the next two years
...
-   Algorithm was more likely to **falsely** flag Black defendants as higher risk/future criminals, and at *almost twice the rate* as White defendants
...
## Example 5: race prediction (cont.)
