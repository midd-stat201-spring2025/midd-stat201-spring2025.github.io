...
1.  Create a variable that represents and stores the target sample size: 10. Then, take a random sample of size 10 of average sleep hours from our population. Store your sample into a variable called `x`.
