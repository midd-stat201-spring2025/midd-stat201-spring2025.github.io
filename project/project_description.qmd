...
Ideally, your report will be submitted both as a PDF and as a `.qmd` file. **The code in your report should be as reproducible as possible** (e.g. not hard coding specific values, setting a seed when appropriate). All tables should be beautiful!
