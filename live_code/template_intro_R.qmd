...
Once you knit, you should note: when we assign an object a value, its value is *not* automatically shown as output. In order to display the output, you must \_\_\_\_\_.
...
When you are finished with your work and ready to submit, you should always knit one last time. You should then submit the most recent knitted output (i.e. the HTML or PDF file) to the corresponding Canvas or Gradescope assignment. Sometimes I will also ask you to submit the accompanying .qmd file. You do **not** need to submit this document.
